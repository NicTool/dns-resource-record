...
`}return l.getTinydnsGeneric(ae(l.getWireRdata()))}function te(l,{tinyline:t}){const e=l.getFields("rdata"),{owner:s,rdata:i,ttl:n,timestamp:a,location:o}=Jt(t,e.length),r={owner:l.fullyQualify(s),type:l.constructor.typeName,ttl:parseInt(n,10),timestamp:a,location:o};for(let c=0;c<e.length;c++){const p=i[c];r[e[c]]=l.isFqdnField(e[c])?l.fullyQualify(p):p}return new l.constructor(r)}function I(l,t){let e="";return t.split(/(.{1})/g).map(s=>{e+=l.test(s)?se(s):s}),e}function x(l){return l.replace(Ot,t=>String.fromCharCode(parseInt(t.slice(1),8)))}function Pt(l){return l.replace(Ot,t=>parseInt(t.slice(1),8).toString(16).padStart(2,0))}function E(l){return parseInt(l.slice(1,4),8)&255}function B(l){return parseInt(l.slice(1,4),8)<<8|parseInt(l.slice(5,8),8)}function gt(l){const t=parseInt(l.slice(1,4),8),e=parseInt(l.slice(5,8),8),s=parseInt(l.slice(9,12),8),i=parseInt(l.slice(13,16),8);return(t<<24|e<<16|s<<8|i)>>>0}function Bt(l){return l.match(/(.{1,255})/g).map(t=>`${y(t.length)}${t}`).join("")}function ee(l){const t=Uint8Array.from(x(l.toString()),a=>a.charCodeAt(0)),e=new TextDecoder,s=[];let i=0,n;for(;(n=t[i])&&(i++,s.push(e.decode(t.subarray(i,i+n))),i=+(i+n),!(i>=t.length)););return s}function N(l){const t=new RegExp(/[^A-Za-z0-9-.]/,"g");let e="";return l.split(".").forEach(s=>{s===void 0||!s.length||(e+=y(s.length),e+=I(t,s))}),e+="\\000",e}function U(l){let t=0,e=0;const s=[],i=()=>{if(t>=l.length)return null;let a;return l[t]==="\\"?(a=parseInt(l.slice(t+1,t+4),8),t+=4):a=l.charCodeAt(t++),e++,a};let n;for(;(n=i())&&n!==0;){let a="";for(let o=0;o<n;o++){const r=i();if(r===null)break;a+=String.fromCharCode(r)}s.push(a)}return[`${s.join(".")}.`,t,e]}function O(l){let t="";for(let e=0;e<l.length;e=e+2)t+=y(parseInt(l.slice(e,e+2),16));return t}function se(l){return y(typeof l=="number"?l:l.charCodeAt(0))}function y(l){if(l>255)throw new Error(`UInt8toOctal: value ${l} exceeds 255 \u2014 tinydns encoders require Latin-1/byte input (code points <= 0xFF)`);return`\\${parseInt(l,10).toString(8).padStart(3,0)}`}function A(l){return y(l>>>8&255)+y(l&255)}function P(l){return y(l>>>24&255)+y(l>>>16&255)+y(l>>>8&255)+y(l&255)}function qt(l){return P(l.split`.`.reduce((t,e)=>t*256+ +e))}function ie(l){const t=gt(l);return[24,16,8,0].map(e=>t>>e&255).join(".")}function Rt(l,t=":"){const e=l.match(/:/g);return e?.length<7&&(l=l.replace(/::/,":".repeat(9-e.length))),l.split(":").map(s=>s.padStart(4,"0")).join(t).toLowerCase()}function ne(l){return O(Rt(l,""))}function re(l){return Pt(l).match(/(.{4})/g).join(":")}function W(l){const t=atob(l);let e="";for(let s=0;s<t.length;s++){const i=t.charCodeAt(s);e+=/[A-Za-z0-9\-.]/.test(t[s])?t[s]:y(i)}return e}function ut(l){return btoa(x(l))}function ae(l){let t="";for(const e of l)t+=y(e);return t}function F(l){return Uint8Array.from({length:l.length/2},(t,e)=>parseInt(l.slice(e*2,e*2+2),16))}function R(l){return[...l].map(t=>t.toString(16).padStart(2,"0")).join("")}function G(l){return btoa([...l].map(t=>String.fromCharCode(t)).join(""))}function L(l){return Uint8Array.from(atob(l),t=>t.charCodeAt(0))}const q={A:1,NS:2,MD:3,MF:4,CNAME:5,SOA:6,MB:7,MG:8,MR:9,NULL:10,WKS:11,PTR:12,HINFO:13,MINFO:14,MX:15,TXT:16,RP:17,AFSDB:18,X25:19,ISDN:20,RT:21,NSAP:22,NSAP_PTR:23,SIG:24,KEY:25,PX:26,GPOS:27,AAAA:28,LOC:29,NXT:30,EID:31,NIMLOC:32,SRV:33,ATMA:34,NAPTR:35,KX:36,CERT:37,A6:38,DNAME:39,SINK:40,OPT:41,APL:42,DS:43,SSHFP:44,IPSECKEY:45,RRSIG:46,NSEC:47,DNSKEY:48,DHCID:49,NSEC3:50,NSEC3PARAM:51,TLSA:52,SMIMEA:53,HIP:55,NINFO:56,RKEY:57,TALINK:58,CDS:59,CDNSKEY:60,OPENPGPKEY:61,CSYNC:62,ZONEMD:63,SVCB:64,HTTPS:65,SPF:99,UINFO:100,UID:101,GID:102,UNSPEC:103,NID:104,L32:105,L64:106,LP:107,EUI48:108,EUI64:109,TKEY:249,TSIG:250,IXFR:251,AXFR:252,MAILB:253,MAILA:254,ANY:255,URI:256,CAA:257,AVC:258,DOA:259,AMTRELAY:260,TA:32768,DLV:32769};function Ut(l,t=0){const e=[];let s=t;for(;s<l.length;){const i=l[s];if(i===0){s++;break}e.push(new TextDecoder().decode(l.subarray(s+1,s+1+i))),s+=1+i}return{fqdn:e.length?e.join(".")+".":".",end:s}}function V(l){if(l===".")return new Uint8Array([0]);const t=new TextEncoder,e=l.split(".").filter(n=>n.length>0).map(n=>{const a=t.encode(n);if(a.length>63)throw new Error(`DNS label exceeds 63 bytes: ${n}`);return a}),s=new Uint8Array(e.reduce((n,a)=>n+a.length+1,1));let i=0;for(const n of e)s[i++]=n.length,s.set(n,i),i+=n.length;return s[i]=0,s}function oe(l){const t=l.toTinydns();if(!t.startsWith(":"))throw new Error(`${l.get("type")}: getWireRdata() not implemented. Override in rr/${l.get("type").toLowerCase()}.js`);const e=t.split(":")[3];return l.octalToUint8Array(e??"")}function ce(l,t){const e=l.getWireRdata(),s=V(l.get("owner")),i=new Uint8Array(s.length+10+e.length);i.set(s,0);const n=new DataView(i.buffer,s.length,10);return n.setUint16(0,l.getTypeId()),n.setUint16(2,t[l.get("class")]??1),n.setUint32(4,l.get("ttl")),n.setUint16(8,e.length),i.set(e,s.length+10),i}function le(l,t,e){const s=new l(null),i=t instanceof Uint8Array?t:new Uint8Array(t),{fqdn:n,end:a}=e(i,0),o=new DataView(i.buffer,i.byteOffset),r=o.getUint16(a+2),c={IN:1,CS:2,CH:3,HS:4,NONE:254,ANY:255},p=Object.keys(c).find(u=>c[u]===r)??"IN",h=o.getUint32(a+4),d=o.getUint16(a+8),g=i.slice(a+10,a+10+d);return s.fromWire({owner:n,cls:p,ttl:h,rdata:g})}function he(l,{owner:t,cls:e,ttl:s,rdata:i}){const n={owner:t,ttl:s,class:e,type:l.constructor.typeName},a=l.constructor.rdataFields??[],o=new DataView(i.buffer,i.byteOffset);let r=0;for(let c=0;c<a.length;c++){const p=a[c],h=Array.isArray(p)?p[0]:p;switch(Array.isArray(p)?p[1]:null){case"u8":n[h]=i[r++];break;case"u16":n[h]=o.getUint16(r),r+=2;break;case"certtype":{const g=o.getUint16(r),u=l.constructor.CERT_TYPES_REVERSE;n[h]=u?.[g]??g,r+=2;break}case"u32":n[h]=o.getUint32(r),r+=4;break;case"fqdn":{const{fqdn:g,end:u}=Ut(i,r);n[h]=g,r=u;break}case"hex":n[h]=R(i.subarray(r)).toUpperCase(),r=i.length;break;case"base64":n[h]=G(i.subarray(r)),r=i.length;break;case"str":n[h]=new TextDecoder().decode(i.subarray(r)),r=i.length;break;case"qstr":n[h]=new TextDecoder().decode(i.subarray(r)),r=i.length;break;case"charstr":{const g=i[r++];n[h]=new TextDecoder().decode(i.subarray(r,r+g)),r+=g;break}case"qcharstr":{const g=i[r++];n[h]=new TextDecoder().decode(i.subarray(r,r+g)),r+=g;break}case"charstrs":{const g=[];for(;r<i.length;){const u=i[r++];if(r+u>i.length)throw new Error("fromWireGeneric: truncated character-string in rdata");g.push(new TextDecoder().decode(i.subarray(r,r+u))),r+=u}n[h]=g.length>1?g:g[0]??"";break}case"svcparams":n[h]=ge(i.subarray(r)),r=i.length;break;case"ipv4":n[h]=[...i.subarray(r,r+4)].join("."),r+=4;break;case"ipv6":{const g=[];for(let u=0;u<16;u+=2)g.push(o.getUint16(r+u).toString(16).padStart(4,"0"));n[h]=g.join(":"),r+=16;break}default:n[h]=i[r++];break}}return new l.constructor(n)}const pe={mandatory:0,alpn:1,"no-default-alpn":2,port:3,ipv4hint:4,ech:5,ipv6hint:6};function Vt(l){if(!l||!l.trim())return new Uint8Array(0);const t=[],e=/([^\s=]+)(?:=(?:"([^"]*)"|(\S*)))?(?=\s|$)/g;let s;for(;(s=e.exec(l.trim()))!==null;){const o=s[1].toLowerCase(),r=s[2]??s[3]??"",c=pe[o];if(c===void 0)continue;let p;if(c===1){const d=new TextEncoder,g=r.split(",").map(b=>d.encode(b.trim())),u=g.reduce((b,w)=>b+1+w.length,0);p=new Uint8Array(u);let m=0;for(const b of g)p[m++]=b.length,p.set(b,m),m+=b.length}else if(c===2)p=new Uint8Array(0);else if(c===3)p=new Uint8Array(2),new DataView(p.buffer).setUint16(0,parseInt(r,10));else if(c===4){const d=r.split(",").map(g=>g.trim().split(".").map(Number));p=new Uint8Array(d.length*4),d.forEach((g,u)=>g.forEach((m,b)=>p[u*4+b]=m))}else if(c===5)p=L(r);else if(c===6){const d=r.split(",").map(g=>F(Rt(g.trim(),"")));p=new Uint8Array(d.length*16),d.forEach((g,u)=>p.set(g,u*16))}else p=new TextEncoder().encode(r);const h=new Uint8Array(4+p.length);new DataView(h.buffer).setUint16(0,c),new DataView(h.buffer).setUint16(2,p.length),h.set(p,4),t.push(h)}t.sort((o,r)=>new DataView(o.buffer).getUint16(0)-new DataView(r.buffer).getUint16(0));const i=t.reduce((o,r)=>o+r.length,0),n=new Uint8Array(i);let a=0;for(const o of t)n.set(o,a),a+=o.length;return n}const de={0:"mandatory",1:"alpn",2:"no-default-alpn",3:"port",4:"ipv4hint",5:"ech",6:"ipv6hint"};function ge(l){if(!l||l.length===0)return"";const t=[];let e=0;for(;e+4<=l.length;){const s=new DataView(l.buffer,l.byteOffset+e),i=s.getUint16(0),n=s.getUint16(2),a=l.subarray(e+4,e+4+n);e+=4+n;const o=de[i]??`key${i}`;if(i===1){const r=[];let c=0;for(;c<a.length;){const p=a[c++];r.push(new TextDecoder().decode(a.subarray(c,c+p))),c+=p}t.push(`alpn="${r.join(",")}"`)}else if(i===2)t.push("no-default-alpn");else if(i===3)t.push(`port=${new DataView(a.buffer,a.byteOffset).getUint16(0)}`);else if(i===4){const r=[];for(let c=0;c<a.length;c+=4)r.push([...a.subarray(c,c+4)].join("."));t.push(`ipv4hint=${r.join(",")}`)}else if(i===5)t.push(`ech=${btoa([...a].map(r=>String.fromCharCode(r)).join(""))}`);else if(i===6){const r=[];for(let c=0;c<a.length;c+=16){const p=new DataView(a.buffer,a.byteOffset+c),h=[];for(let d=0;d<16;d+=2)h.push(p.getUint16(d).toString(16).padStart(4,"0"));r.push(h.join(":"))}t.push(`ipv6hint=${r.join(",")}`)}else t.push(`${o}=${[...a].map(r=>r.toString(16).padStart(2,"0")).join("")}`)}return t.join(" ")}function ue(l,t){const e={class:"IN",type:"",rdata:[]};let s="",i=!1;for(let a=0;a<l.length;a++){const o=l[a];if(o==='"'&&(i=!i),o===";"&&!i)break;s+=o}if(s=s.trim(),!s)return null;const n=s.match(/(".*?"|\S+)/g)||[];if(n.length<1)return null;for(/^\s/.test(l)||(e.owner=n.shift());n.length>0;){const a=n[0].toUpperCase();if(t[a]){e.class=n.shift().toUpperCase();continue}if(/^\d+$/.test(a)){e.ttl=parseInt(n.shift(),10);continue}e.type=n.shift().toUpperCase();break}return e.rdata=n,e}function ye(l,t){const{owner:e,ttl:s,cls:i,rdata:n}=t,a={owner:e,ttl:s,class:i,type:l.constructor.typeName},o=l.getFields("rdata"),r=l.constructor.rdataFields??[];for(let c=0;c<o.length;c++){if(c===o.length-1&&l.isQuotedField(o[c])){const d=n.slice(c).map(m=>m.replace(/^"|"$/g,"")),g=r[c],u=Array.isArray(g)?g[1]:null;a[o[c]]=u==="charstrs"&&d.length>1?d:d.join("");break}let h=n[c];l.isQuotedField(o[c])?h=h?.replace(/^"|"$/g,""):/^\d+$/.test(h)&&(h=parseInt(h,10)),a[o[c]]=h}return new l.constructor(a)}function fe(l,t){const s=l.getFields("rdata").map(i=>l.isFqdnField(i)?l.getFQDN(i,t):l.getQuoted(i)).join("	");return`${l.getPrefix(t)}	${s}
`}const me=Symbol.for("nodejs.util.inspect.custom");class f{static CLASSES={IN:1,CS:2,CH:3,HS:4,NONE:254,ANY:255};static typeId;static RFCs=[];static tags=[];constructor(t){if(t!==null){t?.default&&(this.default=t.default),this.setLocation(t?.location),this.setTimestamp(t?.timestamp),this.setOwner(t?.owner),this.setType(t?.type),this.setTtl(t?.ttl),this.setClass(t?.class);for(const e of this.constructor.rdataFields??[]){const s=f.fieldName(e),i=Array.isArray(e)?e[1]:null,n=`set${this.ucFirst(s)}`;typeof this[n]=="function"?this[n](t?.[s]):i?this.setTypedValue(i,s,t?.[s]):this.set(s,t?.[s])}t?.comment&&this.set("comment",t.comment)}}static fromBind(t,e={}){const s=new this(null);e.default!==void 0&&(s.default=e.default);const i=this.parseBindLine(t);return i?s.fromBind({...e,...i,bindline:t}):null}fromBind(t){return ye(this,t)}static parseBindLine(t){return ue(t,f.CLASSES)}static fromTinydns(t,e={}){const s=new this(null);return e.default!==void 0&&(s.default=e.default),s.fromTinydns({...e,tinyline:t})}fromTinydns(t){return te(this,t)}static fromWire(t){return le(this,t,Ut)}fromWire(t){return he(this,t)}static#t=["__proto__","constructor","prototype"];get(t){if(f.#t.includes(t))throw new Error(`Invalid field name: ${t}`);return this[t]}set(t,e){if(f.#t.includes(t))throw new Error(`Invalid field name: ${t}`);return this[t]=e,this}toJSON(){const t=[...this.getFields(),"location","timestamp","comment"],e={};for(const s of t){const i=this.get(s);i!==void 0&&(e[s]=i)}return e}[me](t,e,s){return`${this.type} ${s(this.toJSON(),e)}`}ucFirst(t){return t&&t.split(/\s/).map(e=>e.charAt(0).toUpperCase()+e.slice(1)).join("")}setClass(t){if([void 0,null,""].includes(t)){this.set("class","IN");return}if(f.CLASSES[t.toUpperCase()]){this.set("class",t.toUpperCase());return}this.throwHelp(`invalid class ${t}`)}setLocation(t){t!==void 0&&this.set("location",t)}setTimestamp(t){t!==void 0&&this.set("timestamp",t)}setOwner(t){t===void 0&&this.throwHelp("owner is required"),(t.length<1||t.length>255)&&this.throwHelp("Domain names must have 1-255 octets (characters): RFC 2181"),this.isFullyQualified(this.constructor.typeName??this.constructor.name,"owner",t),this.hasValidLabels(t),/\*/.test(t)&&!/^\*\./.test(t)&&!/\.\*\./.test(t)&&this.throwHelp("only *.something or * (by itself) is a valid wildcard"),this.set("owner",t.toLowerCase())}setTtl(t){if(t=t??this.default?.ttl,t===void 0){if(["SOA","SSHFP","RRSIG"].includes(this.get("type")))return;this.throwHelp("TTL is required, no default available")}typeof t!="number"&&this.throwHelp(`TTL must be numeric (${typeof t})`),this.is32bitInt(this.get("type"),"TTL",t),this.set("ttl",t)}setType(t){[void 0,""].includes(t)&&(t=this.constructor.typeName),t===void 0&&this.throwHelp("type is required"),t.toUpperCase()!==this.constructor.typeName&&this.throwHelp(`type ${t} doesn't match ${this.constructor.typeName}`),this.set("type",t.toUpperCase())}throwHelp(t){if(!this.constructor.typeName)throw new Error(t);const e=this.constructor.typeName,s=this.getCanonical?`Example ${e}:
