  ...
  describe('escapeOct', function () {
    ...
    for (const c of Object.keys(specialChars)) {
      it(`escapes tinydns rdata special char ${c}`, async function () {
        const e = TINYDNS.escapeOct(rdataRe, c)
