...
const validRecords = [
  {
    ...
    ttl    : 3600,
    testB  : `loc.home.example.com\t3600\tIN\tLOC\t47 43 47 N 122 21 35 W 132 100m 100m 2m\n`,
  ...
  },
  {
    ...
    ttl    : 3600,
    testB  : 'cambridge-net.kei.com\t3600\tIN\tLOC\t42 21 54 N 71 06 18 W -24m 30m\n',
  ...
  },
  {
    ...
    ttl    : 3600,
    testB  : 'rwy04L.logan-airport.boston\t3600\tIN\tLOC\t42 21 28.764 N 71 00 51.617 W -44m 2000m\n',
  ...
  },
  {
    ...
    ttl    : 86400,
    testB  : 'loc.home.simerson.net\t86400\tIN\tLOC\t47 43 47.000 N 122 21 35.000 W 132.00m 100m 100m 2m\n',
